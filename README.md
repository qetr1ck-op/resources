[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) at least for me 🐜
...
This repo is an answer to my daily based question - how to avoid the FOMO effect. The answer is obvious, don't bother your self. Kidding. Seems that one enormous place to manage all those bloody lists is a valid option.
...
- [Evolution series](https://blog.mariusschulz.com/series/typescript-evolution)
...
- [Load balancing performance: comparing cluster module, ip-tables, Nginx](https://medium.com/@fermads/node-js-process-load-balancing-comparing-cluster-iptables-and-nginx-6746aaf38272)
...
- [Binary encoding, Streams, Buffers](https://medium.freecodecamp.org/do-you-want-a-better-understanding-of-buffer-in-node-js-check-this-out-2e29de2968e8)
- [Async hooks](https://medium.com/autodesk-tlv/async-hooks-a-whole-new-world-of-opportunities-a1a6daf1990a)
- [Understand Worker threads in Node.js](https://nodesource.com/blog/worker-threads-nodejs)
...
- [Sub-folders as Dependencies in package.json](https://glebbahmutov.com/blog/subfolders-as-dependencies/)
...
- [HMR - hot module replacement on server side](https://github.com/webpack/docs/issues/45#issuecomment-149793458)
...
- [Node.js Design Patterns - Second Edition: Master best practices to build modular and scalable server-side web applications 2nd Edition](https://www.amazon.com/Node-js-Design-Patterns-server-side-applications-ebook/dp/B01D8HIIFU)
- [Hands-On Microservices with Node.js](https://github.com/ber5ien/Free-DevOps-Books-1/blob/master/book/Developing%20Microservices%20with%20Node.js.pdf)
...
- [How to prevent XSS attacks when using `dangerouslySetInnerHTML`](https://dev.to/donghyukjacobjang/how-to-prevent-xss-attacks-when-using-dangerouslysetinnerhtml-in-react-1464)
...
- [What is the right way to do asynchronous operations in Redux? The comparisons table](https://decembersoft.com/posts/what-is-the-right-way-to-do-asynchronous-operations-in-redux/)
...
- [Angular DOM manipulation techniques using: `ElementRef`, `TemplateRef`, `ViewContainerRef`](https://blog.angularindepth.com/exploring-angular-dom-abstractions-80b3ebcfc02)
...
- [These articles will make you an Angular Change Detection expert](https://blog.angularindepth.com/these-5-articles-will-make-you-an-angular-change-detection-expert-ed530d28930)
...
- [Bullet proof AngularJS migration using iframe](https://codecraft.tv/blog/2017/09/07/angularjs-to-angular-using-iframes/)
...
- [Dynamic template in component, or alternative for `ng1.$compile`](https://stackoverflow.com/questions/38888008/how-can-i-use-create-dynamic-template-to-compile-dynamic-component-with-angular)
...
- [Example application utilizing `@ngrx` libraries, showcasing common patterns and best practices](https://github.com/ngrx/platform/tree/master/example-app)
...
- [`ng2-validation`, inspired by jQuery validation](https://github.com/yuyang041060120/ng2-validation#readme)
...
- [From promises to observables](https://juristr.com/blog/2018/10/journey-promises-to-rxjs/)
...
- [Pereoditic Table of HTML Elements](https://www.madebymike.com.au/demos/html5-periodic-table/)
- [Stop using `div`s, an intro into semantic HTML](https://codeguida.com/post/1770)

## 🙉Books

- [Essential Image Optimization Book by Addy Osmani](https://images.guide/)
...
- [Explanation of UML arrows](https://stackoverflow.com/questions/1874049/explanation-of-the-uml-arrows)
...
- [JSON API – working by specs [Ru]](https://habr.com/ru/company/oleg-bunin/blog/433322/)
...
- [Architecture overview monolith vs micro-services vs serverless](https://codeguida.com/post/1466)
...
- [AWS all services overview](https://academind.com/learn/aws/aws-all-services-overview/)
- [Patterns for distribute transaction within a micro-service architecture](https://developers.redhat.com/blog/2018/10/01/patterns-for-distributed-transactions-within-a-microservices-architecture/)
...
- [Three best books about software architecture](https://proglib.io/p/computer-architecture-books/)

## 🙈Videos

- [Youtube channels](https://habr.com/company/edison/blog/434034)
...
- [Series of Senior is seeking for a job](https://dou.ua/lenta/articles/job-for-senior-4)

#### JavaScript

- [JS tasks](https://habr.com/post/351874)
- [Tricky questions](https://habr.com/company/hh/blog/431698/)
